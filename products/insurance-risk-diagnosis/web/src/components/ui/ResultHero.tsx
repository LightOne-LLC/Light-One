...
export function ResultHero({
  ...
  return (
    <Card variant="hero" as="header" className="surface-sheen surface-sheen-load edge-highlight-dark">
      ...
      <div className="relative grid gap-8 lg:gap-14 lg:grid-cols-[minmax(0,auto)_1fr] lg:items-start">
        <div className="lg:pr-4">
          ...
          {positionLabel && (
            <p className="mt-5 inline-flex items-center gap-2.5 rounded-full border border-white/15 bg-white/[0.06] px-3.5 py-1.5 animate-rise delay-3">
        ...
        <div className="lg:border-l lg:border-white/10 lg:pl-14">
          ...
          {topDomains.length > 0 && (
            <div className="mt-8 sm:mt-9 animate-rise delay-4">
